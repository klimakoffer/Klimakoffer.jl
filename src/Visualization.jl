...
function showGif(field,title_in="Solar Forcing of the Earth: t = ",minval=-46.073107944313556,maxval=32.52216883281448)
    World = read_geography("The_World_Outline.dat")*(-80)
    @gif for t in 1:size(field,3)
        ...
        contour!(LinRange(-180,180,128),LinRange(-90,90,65),transpose(World),xlim=(-180,180), ylim=(-90, 90),levels=-40:40,seriesalpha=0.05)
